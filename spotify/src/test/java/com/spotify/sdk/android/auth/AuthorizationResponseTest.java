...
public class AuthorizationResponseTest {
    ...
    public void shouldCreateFromImplicitGrantFlow() {
        ...
        AuthorizationResponse response = AuthorizationResponse.fromUri(responseUri);

        assertEquals(AuthorizationResponse.Type.TOKEN, response.getType());
    ...
    public void shouldCreateFromNullUrl() {
        AuthorizationResponse response = AuthorizationResponse.fromUri(null);
    ...
    public void shouldCreateFromIncompleteUrl() {
        ...
        assertEquals(AuthorizationResponse.Type.UNKNOWN, response.getType());
        assertNull(response.getState());
        assertNull(response.getError());
        assertNull(response.getCode());
        assertEquals(0, response.getExpiresIn());
    ...
    public void shouldMarshallCorrectly() {
        ...
        AuthorizationResponse responseFromParcel = AuthorizationResponse.CREATOR.createFromParcel(parcel);
